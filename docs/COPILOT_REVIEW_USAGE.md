...
| シーン | 利用 UI | 特徴 |
|--------|---------|------|
| 全体差分レビュー | GitHub PR ページ Copilot パネル | 手軽・その場反映 |
...
## 5. 最小プロンプト例 (コピペ用)
```
Always return the final answer strictly in natural Japanese. Keep code identifiers and proper nouns.
